...
testfolder_path = os.path.join('onlab', 'laptop_telo_hangok') # mappa
test_files = os.listdir(testfolder_path) # file-ok a mappaban
hashes = []
for file in test_files:
    file_path = os.path.join(testfolder_path, file)
